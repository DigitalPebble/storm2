...
``` sh
storm jar target/2-1.0-SNAPSHOT.jar com.dipe.sc.CrawlTopology -conf crawler-conf.yaml -local
```
...
``` sh
storm jar target/2-1.0-SNAPSHOT.jar  org.apache.storm.flux.Flux --local crawler.flux --sleep 86400000
```
